    ...
    return (
        <>
            <div className=' max-w-screen-2xl mx-auto my-40 flex flex-col justify-center items-center dark:text-black '>
                <div className='w-96 flex flex-col gap-5 py-5 px-10 rounded-2xl shadow-2xl shadow-red-200 drop-shadow-2xl dark:bg-slate-500' >
                    <h1 className='text-center font-bold text-2xl my-10'>Contact Us</h1>
                    <label className=" input flex items-center gap-2 dark:bg-slate-200">
                        Name:
                    ...
                    <textarea className=" textarea dark:bg-slate-200" placeholder="Enter your message"></textarea>
